  ...
  <v-app>
    ...
    <v-app-bar extended dark app color="blue accent-4">
      <v-list color="transparent">
        <v-list-item class="mt-10">
          ...
          <v-list-item-content>
            <v-list-item-title class="title">Cartera</v-list-item-title>
            <v-list-item-subtitle class="subtitle-1">$ Registro Información</v-list-item-subtitle>
            <v-list-item-subtitle class="subtitle-1"># clientes</v-list-item-subtitle>
            <v-list-item-subtitle class="subtitle-2 text-right grey--text">actualizado 2 feb 2020</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    </v-app-bar>
    ...
    <v-main>
      <v-container fluid class="blue-grey lighten-5">
        <v-row justify="space-around" class="text-center mt-2 mb-2 d-flex d-sm-none">
          <v-btn-toggle
            v-model="tab"
            dense
            group
          ...
          >
            <span class="mr-8">
              <v-btn value="tab-1" elevation="1" fab top>
                <v-icon top>
                  monetization_on
                </v-icon>
              </v-btn>
          ...
          <v-card class="mx-auto">
            ...
            <v-tabs-items v-model="tab">
              ...
              >
                <v-card flat>
                  <v-card-title>
                    Clientes cartera periodica
                    <v-btn fab small absolute right>
              ...
              >
                <v-card flat>
                  <v-card-text>Prueba 2</v-card-text>
                </v-card>
              </v-tab-item>
              <v-tab-item
                value="tab-3"
              >
                <v-card flat>
                  <v-card-text>Prueba 3</v-card-text>
                </v-card>
              </v-tab-item>
            </v-tabs-items>
          </v-card>
  ...
  data () {
    return {
      ...
      desserts: [
        {
          icon: 'mdi-account',
          nombre: 'Oscar Vasquez',
          dias: '30 dias',
          poliza: 'Oscar SA',
          precio: '$ 3.000.000',
          action: 'keyboard_arrow_right'
        },
        {
          icon: 'mdi-account',
          nombre: 'Andres Vidal',
