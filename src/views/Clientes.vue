    ...
    <v-app-bar extended dark app color="blue accent-4">
      <v-list color="transparent">
        <v-list-item class="mt-10">
          ...
          <v-list-item-content>
            <v-list-item-title class="title">Clientes</v-list-item-title>
            <v-list-item-subtitle class="subtitle-1"># total polizas</v-list-item-subtitle>
